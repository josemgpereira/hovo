                                    ...
                                    <tr style="vertical-align:top">
                                        ...
                                        <td class="jsgrid-align-center">
                                           ...
                                           <?php if($value->leave_status =='Approve'){ ?>
											...
											<a href="" title="Rejeitar" class="btn btn-sm btn-info waves-effect waves-light open-AddRejectReason" data-empid="<?php echo $value->em_id; ?>" data-id="<?php echo $value->id; ?>" data-value="Rejected" data-applydate="<?php echo $value->apply_date; ?>" data-startdate="<?php echo $value->start_date; ?>" data-enddate="<?php echo $value->end_date; ?>" data-duration="<?php echo $value->leave_duration; ?>" data-toggle="modal" data-target="#rejectreasonmodel" data-whatever="@getbootstrap">Rejeitar</a>
  ...
  $(".Status").on("click", function(event){
      ...
      $.ajax({
          ...
          data:
          {
              ...
              'applydate': $(this).attr('data-applydate'),
...
<script>
	$(document).on("click", ".open-AddRejectReason", function () {
        ...
        $(".modal-footer #applydate").val(applydate);
		$(".modal-footer #startdate").val(startdate);
		$(".modal-footer #enddate").val(enddate);
        $(".modal-footer #duration").val(duration);
	});
</script>
