...
<head>
    ...
    <meta name="author" content="Hovo Comunicativo">
    <!-- Favicon icon -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
                        <img src="<?php echo base_url();?>assets/images/hovo.png" alt="DRI" class="DRI-logo" style="width:50px;"/>
                        </b>
					</a>
                </div>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<img src="<?php echo base_url(); ?>assets/images/users/<?php echo $basicinfo->em_image; ?>" alt="Genit" class="profile-pic" style="height:40px;width:40px;border-radius:50px" />
								<?php } else { ?>
								<img src="<?php echo base_url(); ?>assets/images/users/user.png" alt="Genit" class="profile-pic" style="height:40px;width:40px;border-radius:50px" />
								<?php } ?>
							</a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>"><i class="ti-user"></i>Meu Perfil</a></li>
                                    <li><a href="<?php echo base_url(); ?>login/logout"><i class="fa fa-power-off"></i>Terminar Sessão</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
